...
function App() {
  ...
  return (
    <div className="sm:px-[20px] lg:px-[60px] bg-[#000] dark:bg-[#fff]">
      <header className="header flex justify-between items-center py-[10px] lg:rounded-[30px] sm:rounded-[30px_30px_0_0] px-[20px]">
      ...
      <section className="section_1 flex items-center media_query_s_1 pb-[80px] mt-[50px]">
        ...
        >
          <Box className="bg-[#fff] max-w-[300px] rounded-[20px] p-[20px] flex flex-col justify-center items-center gap-1">
            <input
              type="email"
              className="border-[2px] border-[solid] border-[#000] outline-none p-[5px_25px] rounded-[30px] text-[#000] placeholder:text-[#000]"
      ...
      <section className="section_2 mt-[20px] py-[50px]">
        ...
        <div className="s_2_block mt-[30px] flex items-center media_query_s_2 gap-4">
          ...
          <div className="min_block_2_s_2">
            <div className="birth lg:p-[27px_31.5px] md:p-[14px_26px] sm:p-[10px_20px] border-[1px] border-[solid] border-[#fff] dark:border-[#000]">
              <h1 className="text-[#fff] dark:text-[#000] lg:text-[29px] md:text-[21px] sm:text-[16px] font-[400]">
                {t("s2.t3")}: <span>{t("s2.t3Span")}</span>
              </h1>
            </div>
            <div className="place_of_birth lg:p-[27px_31.5px] md:p-[14px_26px] sm:p-[10px_20px] border-[1px] border-[solid] border-[#fff] dark:border-[#000]">
            ...
            <div className="country lg:p-[27px_31.5px] md:p-[14px_26px] sm:p-[10px_20px] border-[1px] border-[solid] border-[#fff] dark:border-[#000]">
              <h1 className="text-[#fff] dark:text-[#000] lg:text-[29px] sm:text-[16px] md:text-[21px] font-[400]">
                {t("s2.t5")}: <span>{t("s2.t5Span")}</span>
              </h1>
            </div>
            <div className="type_of_song lg:p-[27px_31.5px] md:p-[14px_26px] sm:p-[10px_20px] border-[1px] border-[solid] border-[#fff] dark:border-[#000]">
            ...
            <div className="for_btn mt-[40px]">
              ...
              >
                {t("s2.t7")} <KeyboardArrowDownIcon className="icon_dropdown" />
              </button>
            </div>
          </div>
        </div>
      ...
      <footer className="footer mt-[140px] max-w-[1036px] flex gap-[10px] items-center flex-wrap bg-[#00000022] dark:bg-[transparent] px-[20px] py-[10px] border-[10.2px] border-solid border-[#ffffff40] dark:border-[#505050]">
        <a
